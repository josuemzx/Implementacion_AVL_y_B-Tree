...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Img/display_AVL.png}
\caption{Graficador}
\end{figure}
...
\begin{itemize}
   \item Método Insertar Nodo - B-Tree
\end{itemize}

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{Img/insert_Btree.jpeg}
\caption{Método Insertar (num 26)}
\end{figure}

\begin{itemize}
   \item Método Encntrar Nodo - B-Tree
\end{itemize}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Img/encontar_Btree.jpeg}
\caption{Método Encontrar (num 2)}
\end{figure}
